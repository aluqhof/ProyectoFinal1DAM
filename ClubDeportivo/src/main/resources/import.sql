...
INSERT INTO pista (id, numero, precio, aumentoPrecio, deporte_id) VALUES (1, 1, 10.0, 5.0, 1);

INSERT INTO pista (id, numero, precio, aumentoPrecio, deporte_id) VALUES (2, 2, 10.0, 10.0, 1);

INSERT INTO pista (id, numero, precio, aumentoPrecio, deporte_id) VALUES (3, 1, 15.0, 15.0, 2);

INSERT INTO pista (id, numero, precio, aumentoPrecio, deporte_id) VALUES (4, 2, 15.0, 10.0, 2);
