...
INSERT INTO socio (nombre, apellidos, username, password, telefono, fecha_alta, cuota, admin) VALUES ('Juan', 'Pérez', 'admin', '{bcrypt}$2a$10$RlcLSXIvm8VDjEBq19oB7OFEB3sJnxvJETStFrBeHwU1pYc0EGTTa', '123456789', '2023-01-01', 50.0, true);
INSERT INTO socio (nombre, apellidos, username, password, telefono, fecha_alta, cuota, admin) VALUES ('María', 'López', 'user', '{bcrypt}$2a$10$bnFKD2JlOON0nuv94.KPqumWUSa9LORejpDtcumz/Vlg/diEjajzi', '987654321', '2023-02-01', 50.0, false);
INSERT INTO socio (nombre, apellidos, username, password, telefono, fecha_alta, cuota, admin) VALUES ('Pedro', 'García', 'pedrogarcia', 'contraseña789', '555666777', '2023-03-01', 50.0, false);
